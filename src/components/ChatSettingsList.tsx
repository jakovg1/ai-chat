      ...
      {chatSettings.map((setting) => (
        ...
        >
          ...
          <div className="overflow-hidden">
            <span className="text-sm font-medium leading-tight line-clamp-2 text-gray-900 dark:text-gray-200">
              {setting.name}
            </span>
            <span className="text-xs line-clamp-3 text-gray-600 dark:text-gray-400">
              {setting.description}
            </span>
          </div>
        </div>
