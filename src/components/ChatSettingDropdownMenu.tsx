...
const ChatSettingDropdownMenu: React.FC<ChatSettingDropdownMenuProps> = ({
  ...
  const menuItemsClass = `absolute ${
    alignRight ? "right-0" : "left-0"
  } w-56 mt-2 origin-top-left bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 divide-y divide-gray-100 dark:divide-gray-600 rounded-md shadow-lg outline-hidden z-20`;
          ...
          {({ open }) => (
            <>
              <Menu.Button
                ...
                className="inline-flex px-3 text-md font-medium text-gray-700 bg-white dark:text-gray-200 dark:bg-gray-800 rounded-md shadow-xs hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-hidden items-center"
              >
